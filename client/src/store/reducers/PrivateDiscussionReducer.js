  ...
  switch (action.type) {
    ...
    case 'GET_AUTHORIZED':
      ...
      return {
        ...
        noUsers: setNoAuthorizedUsers,
        userCount: setAuthorizedUserCount,
      };
    case 'ADD_AUTHORIZED':
      let setAddAuthorized = state.authorized.concat(action.payload.authorized);
      let setAddAuthorizedId = state.authorizedId.concat(
        action.payload.authorizedId,
      );

      return {
        ...state,
        authorized: setAddAuthorized,
        authorizedId: setAddAuthorizedId,
      };
