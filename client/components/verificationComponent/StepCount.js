  ...
  return (
    <View style={styles.stepContainerRootStyle}>
      <View style={styles.stepContainerStyle}>
        <View style={currentStep === 1 || currentStep === 2 ? {...styles.stepStyle, ...rootCustomStyle, backgroundColor: "#6505E1"} : {...styles.stepStyle, ...rootCustomStyle}} />
        <View style={currentStep === 2 ? {...styles.stepStyle, ...rootCustomStyle, backgroundColor: "#6505E1"} : {...styles.stepStyle, ...rootCustomStyle}} />
